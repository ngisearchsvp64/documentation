...
\subsubsection{Running tests and checking if errors present}
...
\subsubsection{Determining causes of errors}

\begin{itemize}
  \item Incorrect value for character \textbf{c} loaded into \texttt{GPR[4]}
\end{itemize}
